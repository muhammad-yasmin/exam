...
<div class="section">
  <div class="container">
    <div id="idlistdata" >
      <p>Mata Pelajaran adalah bidang studi yang terdapat di sekolah. </p>
...
<script>
    ...
    function btn_edit(id,index){
        ...
        $("#input_id_kelompok").val(
            $.trim($("#kelompokout"+index).html())
        );
        $("#input_id_kode_mapel").val(
            $.trim($("#kodeout"+index).html())
        );
        $("#input_id_nama_mapel").val(
            $.trim($("#namaout"+index).html())
        );
        $("#input_id_tingkat").val(
