<script>
	...
	function load_list_data(){
		...
		$.ajax({
			url: 'app/pages/models/jenis_ujian/load_list_data.php',
			data: {},
			success: function(data){
				$("#animasi_loading").hide();
				$("#div_data_list").html(data);
			},
			error: function(xhr){
				alert("gagal");
			}
	...
	function load_input_biasa(){
        $.ajax({
            url: 'app/pages/models/jenis_ujian/load_input_biasa.php',
            data: {},
            success: function(data){
    ...
    function hapus_function(id,kondisi){
        if(kondisi == true){
            $.ajax({
                url: 'app/pages/models/jenis_ujian/hapus.php',
                type: "POST",
                data: { idkey : id },
