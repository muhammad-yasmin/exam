...
if($jenis_proses == "tambahdata"){
    ...
    if($cek_format == 'oke'){
        $values = array('nomor'=>$input_id_nip,
...
else if($jenis_proses == "setting_mapel"){
    //tambah mapel guru
        foreach ($_POST['input_id_mapel'] as $input_id_mapel) {
            $values2 = array('id_guru'=>$idprimarykey, 'id_mapel'=>$input_id_mapel);
        ...
        if($input_id_jurusan == 0){
            ...
            foreach ($sel_jur as $key => $res_jur) {
                ...
                $values3 = array('id_guru'=>$idprimarykey, 'id_jurusan'=>$whi_jur);
                $que_tambah_jurusan = $conn->insert("guru_jurusan_tabel", $values3);
            }
        }else{
            $values3 = array('id_guru'=>$idprimarykey, 'id_jurusan'=>$input_id_jurusan);
            $que_tambah_jurusan = $conn->insert("guru_jurusan_tabel", $values3);
        }

        if($ptambah && $que_tambah_jurusan){
