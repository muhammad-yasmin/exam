	...
	<div id="divid_id_download" class="form-group">
		...
		<a id="a_id_download"  href="dist/file/format_excel/import_jurusan.xls" target="_blank" class="btn btn-xs btn-warning"><i class="fa fa-download"></i> Download disini..</a>
	</div>
